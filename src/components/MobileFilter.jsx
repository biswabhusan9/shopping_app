...
const MobileFilter = ({openFilter,setOpenFilter, search,setSearch,brand,setBrand,setCategory,priceRange,setPriceRange,category,handleCategoryChange,handleBrandChange}) => {
    ...
    <>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <input type='range' min='0' max='5000' name='' id='' value={priceRange[1]}
          onChange={(e)=>setPriceRange([priceRange[0],Number(e.target.value)])} className='transition-all w-[200px]'
        />
      </div>
