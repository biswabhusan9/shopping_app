...
const FilterSection = ({search,setSearch,brand,setBrand,setCategory,priceRange,setPriceRange,category,handleCategoryChange,handleBrandChange}) => {
    ...
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block'>
      ...
      <div className='flex flex-col gap-2'>
        ...
        <input type='range' min='0' max='5000' name='' id='' value={priceRange[1]}
          onChange={(e)=>setPriceRange([priceRange[0],Number(e.target.value)])} className='transition-all'
        />
      </div>
