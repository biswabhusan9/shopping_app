...
//                   <button onClick={getLocation} className='bg-red-500 text-white px-3 py-2 rounded-md'>Detect Loaction</button>
//                 </div>
//                 </div>
...
//                     <p className='text-red-500 font-semibold'><span className='text-gray-600 line-through px-1'>$5</span>FREE</p>
//                   </div>
//                   <div className='flex justify-between items-center'>
